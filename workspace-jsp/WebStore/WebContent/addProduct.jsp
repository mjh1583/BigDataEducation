		...
		method="post" enctype="multipart/form-data">
			...
			<div class="form-group row">
				...
				<div class="col-sm-5">
					...
					<input type="radio" name="condition" value="Refurblished" /> <fmt:message key="condition_Refurblished" />
				</div>
			</div>
			...
			<div class="form-group row">
				...
				<div class="col-sm-offset-2 col-sm-10">
					...
					<input type="reset" class="btn btn-secondary" value="<fmt:message key="reset" />" />
				</div>
			</div>
