...
public class BWriteCommand implements BCommand {  //게시글 작성하고 그 게시글을 DB에 저장해주는 커맨드 객체

	@Override
	public void execute(HttpServletRequest request, HttpServletResponse response) {
		System.out.println("BWriteCommand 클래스 들어옴");
		...
		System.out.println("BWriteCommand 클래스 실행 후 나감");
	}
